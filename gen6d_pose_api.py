...
# def init_render_model(config_file="configs/gen/neuray_gen_6dof_cost_volume.yaml"):
def init_render_model(config_file="configs/gen/neuray_gen_6dof_pose.yaml"):
    print(f"load config file from {config_file}")
    cfg = load_cfg(config_file)
    cfg["ray_batch_num"] = 8192
...
def gen_6dof_pose( cfg_fn, database_name, ray_num ):
    ...
    # save_render_depth(output_dir, 0, render_info, h, w, dataset_info["que_depth_ranges"])
