...
from utils.gen6d_base_utils import transformation_inverse_2d, project_points, transformation_apply_2d, hpts_to_pts, \
...
def compute_metrics_each(object_pts, diameter, pose_gt, pose_pr, K, scale=1.0, symmetric=False):
