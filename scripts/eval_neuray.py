...
Evaluate the metrics ( lpips, ssim , psnr )
...
if __name__=="__main__":
    ...
    parser.add_argument('--dir_gt', type=str, default='data/render/linemod/gt')
    parser.add_argument('--dir_pr', type=str, default='data/render/linemod/gen')
