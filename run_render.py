...
if __name__=="__main__":
    ...
    print(Fore.GREEN + "[debug] parameters is parsered")
    # "gen" means Generalization Setting
    if flags.render_type=='gen':
        print("[debug] it is Generalization Setting")
    ...
    # "ft" means Finetuning Setting
    else:
        print("[debug] it is Finetuning Setting")
